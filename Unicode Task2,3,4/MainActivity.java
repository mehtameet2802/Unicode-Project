    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        clearbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                birthdate.setText("");
                email.setText("");
                Toast.makeText(MainActivity.this, "Input lines have been cleared", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        allcontacts.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(MainActivity.this, "Going to contacts page", Toast.LENGTH_SHORT).show();
